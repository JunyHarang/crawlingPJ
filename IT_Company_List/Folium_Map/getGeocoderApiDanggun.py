...
companyInfo = 'DanggunMarket', str(address)
foliMap = folium.Map(location=[latitude, longitude], zoom_start=17)
danggunMarketIcon = folium.Icon(color='green', icon='info-sign')
danggunMarketiframe = folium.IFrame(width=300, height=300)
danggunMarketrpopup = folium.Popup(danggunMarketiframe, max_width=650)
folium.Marker([latitude, longitude], popup=danggunMarketrpopup, tooltip=companyInfo, icon=naverIcon).add_to(foliMap)
...
foliMap.save('DanggunMarketMapGraph.html')
