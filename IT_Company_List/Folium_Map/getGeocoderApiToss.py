...
companyInfo = 'Toss', str(address)
foliMap = folium.Map(location=[latitude, longitude], zoom_start=17)
tossrIcon = folium.Icon(color='green', icon='info-sign')
tossiframe = folium.IFrame(width=300, height=300)
tosspopup = folium.Popup(tossiframe, max_width=650)
folium.Marker([latitude, longitude], popup=tosspopup, tooltip=companyInfo, icon=naverIcon).add_to(foliMap)
...
foliMap.save('TossMapGraph.html')
